...
\newcommand{\Ftmone}{\mathcal{F}_{t-1}}
\newcommand{\Ftpone}{\mathcal{F}_{t+1}}
\newcommand{\FT}{\mathcal{F}_T}
\newcommand{\FTmone}{\mathcal{F}_{T-1}}
\newcommand{\FTpone}{\mathcal{F}_{T+1}}
...
\newcommand{\FTL}{\texttt{FTL}\xspace}
\newcommand{\OMD}{\texttt{OMD}\xspace}
\newcommand{\FTRL}{\texttt{FTRL}\xspace}
\newcommand{\TS}{\texttt{TS}\xspace}
\newcommand{\UCB}{\texttt{UCB}\xspace}
\newcommand{\UCRLtwo}{\texttt{UCRL2}\xspace}
\newcommand{\ADAUCB}{\texttt{ADA-UCB}\xspace}
\newcommand{\BayesUCB}{\texttt{Bayes-UCB}\xspace}
\newcommand{\MOSS}{\texttt{MOSS}\xspace}
\newcommand{\MOSSa}{\texttt{MOSS-anytime}\xspace}
\newcommand{\MOTS}{\texttt{MOTS}\xspace}
\newcommand{\UCBE}{\texttt{UCB-E}\xspace}
\newcommand{\UCBV}{\texttt{UCB-V}\xspace}
\newcommand{\ImprovedUCB}{\texttt{ImprovedUCB}\xspace}
\newcommand{\KLUCB}{\texttt{KL-UCB}\xspace}
\newcommand{\KLUCBswitch}{\texttt{KL-UCB-switch}\xspace}
\newcommand{\klUCB}{\texttt{kl-UCB}\xspace}
\newcommand{\KLUCBpp}{\texttt{KL-UCB++}\xspace}
\newcommand{\klucb}{\texttt{KL-UCB}\xspace}
\newcommand{\CUCB}{\texttt{CUCB}\xspace}
\newcommand{\EXP}{\texttt{Exp3}\xspace}
\newcommand{\REXP}{\texttt{Rexp3}\xspace}
\newcommand{\EXPfour}{\texttt{Exp4}\xspace}
\newcommand{\INF}{\texttt{INF}\xspace}
\newcommand{\TsallisINF}{\texttt{Tsallis-INF}\xspace}
\newcommand{\exph}{\EXP}
%linear bandits
...
\newcommand{\epsilongreedy}{\texttt{$\epsilon$-Greedy}\xspace}
\newcommand{\opm}{\texttt{\textcolor[rgb]{0.5,0.2,0}{OPM}}\xspace}

\newcommand{\ForcingBalance}{\texttt{ForcingBalance}\xspace}
...
%RL
\newcommand{\QLearning}{\normalfont\texttt{Q-Learning}\xspace}
...
%%% todos
\usepackage[colorinlistoftodos, textwidth=30mm, shadow, textsize=small,disable]{todonotes}
\definecolor{blued}{rgb}{0.54, 0.81, 0.94}
...
\newcommand\todoju[1]{\todo[color=blued,inline]{#1}}
\newcommand{\todoj}[1]{\todo[color=blued]{\tiny#1}}
...
\newcommand{\HPt}[1]{\xi^\alpha_{{#1}}}
\newcommand{\HPeff}{\xi^\alpha_{t,\, m}}
\newcommand{\HPtwo}{\xi^\alpha_{t,\, 2}}
...
\newcommand{\Hitwo}{H_{i,\,2}}
\newcommand{\Hitm}{H_{i_t,\,m}}
\newcommand{\hmueff}{\hmu_{i,\texttt{\footnotesize{eff}}}^{h_j}}
\newcommand{\hmuiteff}{\hmu_{i_t,\texttt{\footnotesize{eff}}}^{h_j}}
\newcommand{\bmueff}{\bmu_{i,\texttt{\footnotesize{eff}}}^{h_j}}
\newcommand{\bmuiteff}{\bmu_{i_t,\texttt{\footnotesize{eff}}}^{h_j}}
\newcommand{\neff}{n_i^{h_j}}
...
\newcommand{\oracle}{\Tilde{\pi}^\star}
\newcommand{\armsbelow}{\arms_t^-}
\newcommand{\armsabove}{\arms_t^+}
\newcommand{\Krt}{\arms_t^r}
\newcommand{\Krtpone}{\arms_{t+1}^r}
\newcommand{\state}{\boldsymbol{\mu}}
\newcommand{\statet}{\boldsymbol{\mu_t}}
\newcommand{\statetit}{\statet^{\boldsymbol{i_t}}}
\newcommand{\statetmone}{\state_{\boldsymbol{t-1}}}
\newcommand{\statetpone}{\state_{\boldsymbol{t+1}}}
\newcommand{\statetmoneit}{\statetmone^{\boldsymbol{i_t}}}
\newcommand{\statetponeit}{\statetpone^{\boldsymbol{i_t}}}
\newcommand{\Ort}{\Or(\statet)}
\newcommand{\Ortmone}{\Or(\statetmone)}
\newcommand{\Ortpone}{\Or(\statetpone)}
\newcommand{\Ormonet}{\Ormone(\statet)}
\newcommand{\Ormonetmone}{\Ormone(\statetmone)}
\newcommand{\Ormonetpone}{\Ormone(\statetpone)}
\newcommand{\Ortit}{\Or(\statetit)}
\newcommand{\Ortmoneit}{\Or(\statetmoneit)}
\newcommand{\Ortponeit}{\Or(\statetponeit)}
\newcommand{\Ormonetit}{\Ormone(\statetit)}
\newcommand{\Ormonetmoneir}{\Ormone(\statetmone^{\boldsymbol{i_r}})}
\newcommand{\Ormonetir}{\Ormone(\statet^{\boldsymbol{i_r}})}
\newcommand{\Ormonetponeir}{\Ormone(\statetpone^{\boldsymbol{i_r}})}
\newcommand{\Ormonetmoneit}{\Ormone(\statetmoneit)}
\newcommand{\Ormonetponeit}{\Ormone(\statetponeit)}
\newcommand{\Or}{\OO_r}
\newcommand{\Ormone}{\OO_{r-1}}
\newcommand{\Tpi}{\Tilde{\pi}}
\newcommand{\Tpikt}{\Tilde{\pi}_{k,t}}
\newcommand{\TpikT}{\Tilde{\pi}_{k,T}}
\newcommand{\isT}{i^\star_T}
\newcommand{\FLUT}{\normalfont\texttt{FLUT}\xspace}
\newcommand{\FLUTE}{\normalfont\texttt{FLUT-E}\xspace}
\newcommand{\ucb}{\normalfont\operatorname{ucb}\xspace}
\newcommand{\lcb}{\normalfont\operatorname{lcb}\xspace}
